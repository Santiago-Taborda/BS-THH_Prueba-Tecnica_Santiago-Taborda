export type productType = {
  ...
  reviews: {
    ...
    reviewerName: string;
    reviewerEmail?: string; // Optional field
  }[];
  returnPolicy?: string; // Optional field
  minimumOrderQuantity?: number; // Optional field
  meta?: {
    createdAt?: string; // ISO date format
    updatedAt?: string; // ISO date format
    barcode?: string; // Optional field
    qrCode?: string; // Optional field
  };
  images?: string[]; // Optional field (array of image URLs)
  thumbnail?: string; // Optional field (URL of thumbnail image)
};
